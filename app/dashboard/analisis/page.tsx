    ...
    return (
      <div className="w-full max-w-4xl mx-auto">
        <div className="mb-8 border-b border-zinc-200 dark:border-zinc-800 pb-4">
          <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-linear-to-r from-blue-500 via-cyan-500 to-emerald-500 dark:from-blue-400 dark:via-cyan-400 dark:to-emerald-400">
        ...
        <div className="p-16 text-center border-2 border-dashed border-zinc-300 dark:border-zinc-800 rounded-2xl bg-zinc-100/50 dark:bg-zinc-900/40">
          ...
          <h3 className="text-xl font-medium text-zinc-700 dark:text-zinc-300 mb-2">No hay datos activos en esta sesión</h3>
          ...
          <Link
            ...
            className="bg-zinc-800 hover:bg-zinc-700 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-white font-medium py-3 px-6 rounded-xl transition-colors border border-zinc-700 inline-flex items-center gap-2"
          >
    ...
    <div className="w-full max-w-7xl mx-auto pb-12">
      <div className="mb-8 border-b border-zinc-200 dark:border-zinc-800 pb-4">
        ...
        <p className="text-zinc-500 dark:text-zinc-400 mt-2 flex items-center gap-2">
          Consulta las zonas disponibles y aplica reglas de estandarización territorial.
          <span className="ml-2 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800/50 px-2 py-0.5 rounded font-mono text-xs hidden sm:inline-block">
            ID: {datasetId}
          </span>
        </p>
      </div>
      ...
      {/* TARJETAS KPI */}
      {isKpiLoading ? (
        <div className="flex justify-center items-center py-12 mt-8 border border-zinc-200 dark:border-zinc-800 rounded-xl bg-zinc-100/50 dark:bg-zinc-900/50">
          <div className="animate-spin rounded-full h-10 w-10 border-t-2 border-b-2 border-blue-500"></div>
          <span className="ml-3 text-zinc-500 dark:text-zinc-400">Calculando métricas...</span>
        </div>
      ) : isKpiError || !kpiData ? (
        <div className="mt-8 p-6 border border-dashed rounded-xl border-zinc-300 dark:border-zinc-700 bg-zinc-100/50 dark:bg-zinc-900/50 flex flex-col items-center justify-center">
          <p className="text-zinc-500 dark:text-zinc-400 font-medium">Métricas no disponibles</p>
        </div>
      ) : (
      ...
      <div className="p-8 border border-zinc-200 dark:border-zinc-800 rounded-2xl bg-white dark:bg-zinc-900/50 mt-8 shadow-sm dark:shadow-lg dark:shadow-black/20">
        {isZonesLoading ? (
          ...
          <>
            ...
            <div className="mt-12 pt-8 border-t border-zinc-200 dark:border-zinc-800">
              <h2 className="text-xl font-semibold text-transparent bg-clip-text bg-linear-to-r from-blue-500 to-cyan-500 dark:from-blue-400 dark:to-cyan-400 mb-6">
      ...
      <div className="mt-8 p-8 border border-zinc-200 dark:border-zinc-800 rounded-2xl bg-white dark:bg-zinc-900/50 shadow-sm dark:shadow-lg dark:shadow-black/20">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 border-b border-zinc-200 dark:border-zinc-800/50 pb-6">
          <div>
            <h2 className="text-xl font-semibold text-transparent bg-clip-text bg-linear-to-r from-blue-500 via-cyan-500 to-emerald-500 dark:from-blue-400 dark:via-cyan-400 dark:to-emerald-400">
              Ranking de Zonas y Plan de Acción
            </h2>
            <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1">Calcula el score y selecciona una zona para ver las recomendaciones estratégicas.</p>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start relative">
          ...
          {selectedZone && datasetId && (
            <div className="w-full lg:w-[60%] animate-in slide-in-from-right-8 fade-in duration-500 sticky top-8">
              <div className="h-full border border-zinc-200 dark:border-zinc-700/50 rounded-2xl bg-zinc-50 dark:bg-zinc-950/40 p-1"> 
